...
describe("verifyWebhookSignature", () => {
  ...
  const body =
    '{"event":"task.created","timestamp":"2025-01-15T10:30:00Z","data":{"id":"1","name":"Test"}}'
...
describe("parseWebhookPayload", () => {
  it("should parse valid JSON payload", () => {
    const body =
      '{"event":"task.created","timestamp":"2025-01-15T10:30:00Z","data":{"id":"1","name":"Test Task"}}'
...
describe("webhook signature end-to-end", () => {
  it("should generate and verify signature correctly", () => {
    ...
    const result = verifyWebhookSignature(secret, signatureHeader, body, {
      maxAge: 300,
    })
