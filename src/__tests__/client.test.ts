...
describe("createLocuClient", () => {
  ...
  describe("projects", () => {
    it("should list projects", async () => {
      ...
      await client.projects.list({ state: "planned" as const })
  ...
  describe("sessions", () => {
    it("should list sessions", async () => {
      ...
      await client.sessions.list({ includeActivities: true as const })
    ...
    describe("activities", () => {
      ...
      it("should create an activity", async () => {
        ...
        const result = await client.sessions.activities.create(
          "session-1",
          newActivity
        )
  ...
  describe("webhooks", () => {
    ...
    it("should create a webhook with secret", async () => {
      ...
      const mockResponse = {
        id: "1",
        url: newWebhook.url,
        entityTypes: newWebhook.entityTypes,
